"""
Steepest Ascent Hill Climbing - Máy Hút Bụi
==============================================
Thuật toán: Đánh giá TẤT CẢ láng giềng, chọn láng giềng có h THẤP NHẤT.
Nếu h tốt nhất >= h hiện tại → dừng (kẹt tại local optimum).
...
def steepest_hill_climbing(start_state):
    ...
    - Chọn láng giềng có h THẤP NHẤT (tốt nhất)
    - Dừng khi h tốt nhất >= h hiện tại (không cải thiện)
    """
    current = start_state
    ...
    for step in range(1, MAX_STEPS + 1):
        ...
        trace.append({
            ...
            "note": f"Chọn {action} (h={next_h}) - láng giềng TỐT NHẤT"
        })
...
class SteepestHillClimbingApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Steepest Ascent Hill Climbing - Máy Hút Bụi")
    ...
    def _build_gui(self):
        title = tk.Label(
            self.root, text="🧹 STEEPEST ASCENT HILL CLIMBING - MÁY HÚT BỤI",
            font=("Segoe UI", 16, "bold"), bg="#2d3436", fg="white"
        )
        title.pack(pady=(10, 5))

        subtitle = tk.Label(
            self.root, text="Đánh giá TẤT CẢ láng giềng, chọn láng giềng TỐT NHẤT (h thấp nhất)",
        ...
        trace_label = tk.Label(right_frame, text="Bảng Trace - Steepest Ascent Hill Climbing",
    ...
    def make_trace_text(self):
        ...
        step_w, h_w, action_w, neighbors_w, note_w = 6, 6, 12, 50, 45
    ...
    def solve(self):
        try:
            ...
            self.path, self.trace = steepest_hill_climbing(self.start_state)
            self.current_step = 0
...
if __name__ == "__main__":
    ...
    app = SteepestHillClimbingApp(root)
    root.mainloop()
