...
class VacuumApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Máy Hút Bụi - AND-OR Search")
    ...
    def _build_gui(self):
        tk.Label(self.root, text="MÁY HÚT BỤI — AND-OR Search", font=("Segoe UI", 16, "bold"), bg="#2d3436", fg="white").pack(pady=(10, 5))
